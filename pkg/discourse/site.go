...
type SiteInfo struct {
	...
	CustomEmojiTranslation              map[string]string      `json:"custom_emoji_translation"`
	WatchedWordsReplace                 string                 `json:"watched_words_replace"`
	WatchedWordsLink                    string                 `json:"watched_words_link"`
	MarkdownAdditionalOptions           map[string]string      `json:"markdown_additional_options"`
	HashtagConfigurations               map[string]string      `json:"hashtag_configurations"`
	HashtagIcons                        map[string]string      `json:"hashtag_icons"`
	...
	AuthProviders                       []map[string]string    `json:"auth_providers"`
